...
export default function HeroSection() {
    return (
        <section className="w-full bg-purple-700 md:py-16 lg:py-20">
                    ...
                    <div className="w-full max-w-3xl mx-auto mt-8">
                        <div className="bg-white rounded-xl shadow-xl p-6 md:p-8">
                            ...
                            <div className="mt-6 flex justify-center">
                                <button className="w-full md:w-auto flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-700 to-purple-500 text-white font-semibold rounded-lg hover:from-purple-800 hover:to-purple-600">
