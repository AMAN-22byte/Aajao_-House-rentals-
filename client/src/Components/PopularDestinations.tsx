        ...
        <section className="w-full py-12 md:py-24 lg:py-22">
            <div className="container px-4 md:px-6">
                ...
                <div className="mx-auto grid max-w-5xl grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
                    ...
                    <div className="group relative overflow-hidden rounded-lg shadow-lg transition-all hover:shadow-xl">
                        <div className="absolute right-3 top-3 z-10">
                            <button
                                className="rounded-full bg-white/80 text-purple-700 hover:bg-white hover:text-purple-900 p-2"
                        ...
                        <a href="#" className="block">
                            ...
                            <div className="p-4 bg-white">
                                <div className="flex items-center justify-between">
                                    <h3 className="text-lg font-semibold text-purple-900">Luxury Villa 1</h3>
                    ...
                    <div className="group relative overflow-hidden rounded-lg shadow-lg transition-all hover:shadow-xl">
                        ...
                        <a href="#" className="block">
                            ...
                            <div className="p-4 bg-white">
                                <div className="flex items-center justify-between">
                                    <h3 className="text-lg font-semibold text-purple-900">Luxury Villa 2</h3>
                                    <div className="flex items-center">
                                        <Star className="h-4 w-4 fill-purple-500 text-purple-500" />
                    ...
                    <div className="group relative overflow-hidden rounded-lg shadow-lg transition-all hover:shadow-xl">
                        ...
                        <a href="#" className="block">
                            ...
                            <div className="p-4 bg-white">
                                <div className="flex items-center justify-between">
                                    <h3 className="text-lg font-semibold text-purple-900">Luxury Villa 3</h3>
                                    <div className="flex items-center">
                                        <Star className="h-4 w-4 fill-purple-500 text-purple-500" />
                    ...
                    <div className="group relative overflow-hidden rounded-lg shadow-lg transition-all hover:shadow-xl">
                        ...
                        <a href="#" className="block">
                            ...
                            <div className="p-4 bg-white">
                                <div className="flex items-center justify-between">
                                    <h3 className="text-lg font-semibold text-purple-900">Luxury Villa 4</h3>
                                    <div className="flex items-center">
                                        <Star className="h-4 w-4 fill-purple-500 text-purple-500" />
                    ...
                    <div className="group relative overflow-hidden rounded-lg shadow-lg transition-all hover:shadow-xl">
                        ...
                        <a href="#" className="block">
                            ...
                            <div className="p-4 bg-white">
                                <div className="flex items-center justify-between">
                                    <h3 className="text-lg font-semibold text-purple-900">Luxury Villa 5</h3>
                                    <div className="flex items-center">
                                        <Star className="h-4 w-4 fill-purple-500 text-purple-500" />
                                        <span className="ml-1 text-sm font-medium">4.9</span>
                                    </div>
                    ...
                    <div className="group relative overflow-hidden rounded-lg shadow-lg transition-all hover:shadow-xl">
                        ...
                        <a href="#" className="block">
                            ...
                            <div className="p-4 bg-white">
                                <div className="flex items-center justify-between">
                                    <h3 className="text-lg font-semibold text-purple-900">Luxury Villa 6</h3>
                                    <div className="flex items-center">
                                        <Star className="h-4 w-4 fill-purple-500 text-purple-500" />
                                        <span className="ml-1 text-sm font-medium">4.7</span>
                                    </div>
                ...
                <div className="flex justify-center mt-10">
                    <a
                        href="#"
                        className="inline-flex items-center border border-purple-200 text-purple-700 hover:bg-purple-50 px-4 py-2 rounded-md font-medium"
                    >
